...
- **Microcontrolador:**
    ...
    En el DTHIS-C, el microcontrolador es fundamental para gestionar y procesar las señales de los sensores, convirtiendo las salidas analógicas en datos digitales precisos mediante el ADC. Estos datos se utilizan para evaluar las condiciones ambientales y se transmiten a una plataforma IoT para su visualización en tiempo real.
...
El siguiente script gestiona el Adafruit PT1000 RTD-MAX31865, encargado de convertir las señales analógicas del TPF1/E-20 PT1000 a valores digitales, permitiendo obtener las mediciones de la temperatura radiante:
...
Este script se encarga de capturar y almacenar las mediciones de humedad relativa, concentración de CO<sub>2</sub> y temperatura ambiente proporcionadas por el sensor SCD30:
```{python}
#| eval: false
#| code-overflow: wrap
import time
