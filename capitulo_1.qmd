...
El análisis del estado del arte permite identificar los desarrollos académicos más relevantes en torno a dispositivos de monitoreo ambiental y de confort interior. En la @tbl-proyectos se comparan distintos proyectos nacionales e internacionales, en su mayoría tesis, artículos y prototipos a pequeña escala, que han abordado la medición de variables como temperatura, humedad relativa y concentración de CO<sub>2</sub>. Esta comparación pone en evidencia tanto los alcances como las limitaciones de cada iniciativa, y permite destacar el valor agregado que aporta el DTHIS-C frente a estas propuestas.
